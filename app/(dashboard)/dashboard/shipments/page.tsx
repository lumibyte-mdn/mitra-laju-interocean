        ...
        <>
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold text-gray-900">Shipments</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the shipments in your shipment database including their order number, customer code, shipper and input date.
                    </p>
                    </div>
