...
import { CheckIcon, ChevronUpDownIcon, FolderIcon } from "@heroicons/react/16/solid";
...
export default function shipmentAdd() {
    ...
    const totalAllVendors = useMemo(() => {
        return costings.reduce((acc, item) => acc + parseNumber(item.paymentvendor), 0);
    }, [costings]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (vendor && price && currency && amount && localfee && ppnfreight && subcosting && reimbursement && totalcost && paymentvendor && paymentdate && qty) {
                        ...
                        <div className="px-4 sm:px-6 lg:px-8">
                            <div className="flex justify-between items-center">
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="inline-block rounded-md bg-[#1A5098] px-3 py-2 text-center text-sm font-medium text-white shadow-xs hover:bg-[#1a5198eb] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1A5098]"
                                    >
                                ...
                                <div>
                                    <div className="mt-8">
                                        ...
                                        <div className="flex items-center w-1/2 justify-between mt-4">
                                            ...
                                            <div className="w-2/3">
                                                <Listbox value={selectedUkuran} onChange={setSelectedUkuran}>
                                        ...
                                        <div className="flex items-center w-1/2 justify-between mt-4">
                                            ...
                                            <div className="w-2/3">
                                                <Listbox value={selectedTipe} onChange={setSelectedTipe}>
                                                    <div className="relative">
                                                        <ListboxButton className="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-1.5 pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-[#1A5098] sm:text-sm/6">
                                        ...
                                        <div className="flex gap-12">
                                                                ...
                                                                <div className="flex items-center justify-start">
                                                                    <div className="group grid size-4 grid-cols-1">
                                                                        <input
                                                                            ...
                                                                            name="candidates"
                                                                            value={1.1}
                                                                            checked={selectedTaxes.includes(1.1)}
                                                                ...
                                                                <div className="flex items-center">
                                                                    <div className="group grid size-4 grid-cols-1">
                                                                        <input
                                                                            id="candidates"
                                                                            name="candidates"
                                                                            checked={selectedTaxes.includes(2)}
                                            ...
                                            <div className="w-1/2">
                                                <div className="bg-white py-4 px-6 rounded-lg">
                                                    ...
                                                    <div className="mt-4">
                                                        <label htmlFor="price" className="block text-sm/6 font-medium text-gray-900">Total Payment Vendor :</label>
                                                        <div className="">
                                                            <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-[#1A5098]">
                                                                <div className="shrink-0 text-base text-gray-500 select-none sm:text-sm/6">Rp.</div>
                                                                <input
                                                                    ...
                                                                    inputMode="numeric"
                                                                    min={0}
                                                                    value={totalAllVendors.toLocaleString('id-ID', {
